...
同理：\\
$\log_b \frac{M}{N} =\log_bM - \log_bN$ \;\;\;\;\;\; $\log_bM^n =n\log M(\log \overbrace{M\cdots M}^n)$.
...
比较$a、b$大小，本质上是减法，只需要证明$a-b$和$0$的关系，亦或者$a/b$和$1$的关系($\frac{a}{b}-1=\frac{a-b}{b}$，本质上也是减法)。

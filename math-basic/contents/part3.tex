...
\begin{minipage}{0.3\textwidth}
  ...
  \begin{tikzpicture}
    ...
    \tkzLabelPoints[scale=0.8](B,C,P)
    \tkzLabelPoints[above, scale=0.8](A)
  \end{tikzpicture}
\end{minipage}
\begin{minipage}{0.3\textwidth}
  \begin{tikzpicture}
    ...
    \tkzLabelPoints[scale=0.8](B,C,P)
    \tkzLabelPoints[above, scale=0.8](A)
    \tkzLabelPoints[above right, scale=0.8](P')
    \tkzLabelPoints[left, scale=0.8](A')
  \end{tikzpicture}
\end{minipage}
...
\center
  \begin{tikzpicture}[scale=0.6]
    ...
    \tkzLabelPoints[scale=0.8](A')
    \tkzLabelPoints[above, scale=0.8](A)
    \tkzLabelPoints[left, scale=0.8](B, C')
    \tkzLabelPoints[right, scale=0.8](C, B', P)
  \end{tikzpicture}
\end{minipage}
...
\begin{minipage}{0.33\textwidth}
  ...
  \begin{tikzpicture}
    ...
    \tkzLabelPoints[scale=0.8](B,C,P)
    \tkzLabelPoints[above, scale=0.8](A)
    \tkzLabelPoints[above right, scale=0.8](P', E)
    \tkzLabelPoints[left, scale=0.8](A', D)
  \end{tikzpicture}
\end{minipage}
\begin{minipage}{0.33\textwidth}
  \center
  \begin{tikzpicture}
    ...
    \tkzLabelPoints[scale=0.8](B,C)
    \tkzLabelPoints[above, scale=0.8](A, P', P, E)
    % \tkzLabelPoints[above right, scale=0.8](P', E)
    \tkzLabelPoints[left, scale=0.8](A', D)
  \end{tikzpicture}
\end{minipage}
...
\begin{minipage}[c]{0.33\textwidth}
  ...
  \begin{tikzpicture}
    ...
    \tkzDrawPoints(A,B,C)
    \tkzLabelPoints[scale=0.8](A,B)
    \tkzLabelPoints[scale=0.8,right](C)
...
\begin{minipage}[c]{0.33\textwidth}
  ...
  \begin{tikzpicture}
    ...
    % \tkzDrawPoints(O)
    \tkzLabelPoints[scale=0.6, above left](O)
...
\begin{minipage}[c]{0.33\textwidth}
  ...
  \begin{tikzpicture}[scale=1.1]
    ...
    % \tkzDrawPoints(O)
    \tkzLabelPoints[scale=0.6, below](O)
    ...
    \tkzDrawSegment[dashed](O,E)
    \tkzMarkRightAngle[scale=0.8](A,E,O)
    \tkzLabelPoints[scale=0.8](D)
    \tkzLabelPoints[scale=0.8, above](E)
